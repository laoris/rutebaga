...
/**
 * Abstract node class for use with {@link AStarSearch}.
 * AStarNode should be subclassed to provide searching capability.
 * 
...
public abstract class AStarNode implements Comparable<AStarNode>{
	...
	/**
	 * Gets estimated cost between this node and passed node.
	 * Should never be greater than actual cost.
	 * 
	 * @param node
	 * @return float
	 */
