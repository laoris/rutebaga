 ...
 * 
 * Execution results in the execution of a StatEffect upon the entity.
 * The returned token for this effect is provided.
 * 
 * Damage has three components:
 * 
 * - A symbolic function that provides the magnitude of the change
 *   to the statistic;<br/>
 * - The classification of this damage;
 * - The statistic to be damaged
 * 
