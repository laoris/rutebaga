 ...
 * behavior will forward to its EntityType. Subclasses of {@link Entity} that
 * require new operations should defer the execution of those operations to
 * their own subclass of EntityType.
 * 
 * @author Nick
 * @see Entity
 */
public class EntityType
{
	...
	public void tick(Entity entity)
	{
		...
		// XXX: perhaps make a singular method in entity to tick its children?
		// (glosh)
