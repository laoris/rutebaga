...
/**
 * Manages an {@link Instance}'s {@link MovementAttributeSet}s.  These MovementAttributeSets
 * define the what TerrainType's an Instance is allowed onto.
 * 
...
public class MovementAttributes {
	...
	public boolean able( TerrainType terrain ) {
		Iterator<MovementAttributeSet> masIterator = movementSet.values().iterator();
