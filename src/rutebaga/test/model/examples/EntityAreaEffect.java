package rutebaga.test.model.examples;
...
public class EntityAreaEffect extends Instance<EntityAreaEffect>
{
	...
	public EntityAreaEffect(InstanceType<EntityAreaEffect> type)
	{
		super(type);
	}
