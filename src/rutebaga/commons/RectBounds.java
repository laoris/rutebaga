...
public class RectBounds extends Bounds {
	 ...
	 * @param v {@link Vector} to be checked.
	 * @return A boolean representing {@link Vector} v's containment in this RectBounds.
	 * @see Vector
	 */
	...
	/**
	 * Returns the {@link Vector} representing this RectBounds' lower-left corner.
	 * @return The {@link Vector} representing this RectBounds' lower-left corner.
	 * @see Vector
	 */
	...
	/**
	 * Returns the {@link Vector} representing this RectBounds' upper-right corner, or size.
	 * @return The {@link Vector} representing this RectBounds' lower-left corner.
	 * @see Vector
	 */
	...
	/**
	 * Sets the lower-left corner of this RectBounds to the specified {@link Vector}.
	 * @param lower The {@link Vector} representing the RectBounds' new lower-left corner.
	 * @see Vector
	 */
	...
	/**
	 * Sets the size, or upper-right corner of this RectBounds to the specified {@link Vector}.
	 * @param size The {@link Vector} representing the RectBounds' new upper-right corner.
	 * @see Vector
	 */
